    ...
    <tbody>
        ...
        <?php foreach ($subComponents['data'] as $subComponent) : ?>
            <tr>
                ...
                <td><?= if_empty(str_replace(',', ', ', $subComponent['components']), '-') ?></td>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <?php if (AuthorizationModel::isAuthorized(PERMISSION_SUB_COMPONENT_DELETE)) : ?>
                                ...
                                <a class="dropdown-item btn-delete" href="#modal-delete" data-toggle="modal" data-id="<?= $subComponent['id'] ?>" data-label="<?= $subComponent['sub_component'] ?>" data-title="Sub Component" data-url="<?= site_url('master/sub-component/delete/' . $subComponent['id']) ?>">
