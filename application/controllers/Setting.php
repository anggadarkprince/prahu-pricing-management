...
class Setting extends App_Controller
{
    ...
    protected function _validation_rules()
    {
        return [
            ...
            'email_bug_report' => 'trim|required|max_length[50]|valid_email',
            'email_support' => 'trim|required|max_length[50]|valid_email',
            'email_token' => 'trim|required|max_length[50]|valid_email',
