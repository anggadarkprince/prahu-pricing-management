        ...
        <?php foreach ($componentPrices['data'] as $componentPrice) : ?>
            <tr>
                ...
                <td class="text-nowrap">
                    Rp. <?= numerical($componentPrice['price']) ?><br>
                    <small class="text-muted text-nowrap"><?= $componentPrice['expired_date'] ?></small>
                </td>
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <?php if (AuthorizationModel::isAuthorized(PERMISSION_COMPONENT_PRICE_DELETE)) : ?>
                                ...
                                <a class="dropdown-item btn-delete" href="#modal-delete" data-toggle="modal" data-id="<?= $componentPrice['id'] ?>" data-label="<?= numerical($componentPrice['price']) ?>" data-title="Component Price" data-url="<?= site_url('master/component-price/delete/' . $componentPrice['id']) ?>">
