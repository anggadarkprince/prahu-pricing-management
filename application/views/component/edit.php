		...
		<div class="col-sm-6">
			<div class="form-group">
				...
				<select class="form-control select2" name="service_section" id="service_section" data-placeholder="Select service location" required>
					<option value=""></option>
					<option value="ORIGIN" <?= set_select('service_section', 'ORIGIN', $component['service_section'] == 'ORIGIN') ?>>
						ORIGIN
					</option>
					<option value="SHIPPING" <?= set_select('service_section', 'SHIPPING', $component['service_section'] == 'SHIPPING') ?>>
						SHIPPING
					</option>
					<option value="DESTINATION" <?= set_select('service_section', 'DESTINATION', $component['service_section'] == 'DESTINATION') ?>>
						DESTINATION
					</option>
				</select>
